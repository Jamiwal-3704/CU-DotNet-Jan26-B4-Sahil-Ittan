...
using WealthTrackPortfolioManager.Data;
using WealthTrackPortfolioManager.Models;
using WealthTrackPortfolioManager.ViewModels;

namespace WealthTrackPortfolioManager.Controllers
{
    public class InvestmentsController : Controller
    {
        private readonly WealthTrackPortfolioManagerContext _context;

        public InvestmentsController(WealthTrackPortfolioManagerContext context)
        {
            _context = context;
        }
        ...
        //public async Task<IActionResult> Create([Bind("Id,TickerSymbol,AssetName,PurchasePrice,Quantity,PurchaseDate")] Investment investment)
        //{
