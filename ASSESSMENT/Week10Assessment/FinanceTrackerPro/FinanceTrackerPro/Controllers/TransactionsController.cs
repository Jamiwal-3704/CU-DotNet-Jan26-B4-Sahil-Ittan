...
namespace FinanceTrackerPro.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public TransactionsController(FinanceTrackerProContext context)
        {
            _context = context;
        }
        ...
        {
            var financeTrackerProContext = _context.Transaction.Include(t => t.account);
            return View(await financeTrackerProContext.ToListAsync());
        }
